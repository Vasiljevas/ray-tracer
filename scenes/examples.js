...
export function AssortedShapes10(reflection = 0.5) {    
    let shiny = new Finish({ shiny: 0.5, reflection: reflection });
    let camera = new Camera(new Vector(-10, 10, -20), new Vector(0, 4, 0));
    let background = new Color(0, 0, 0);
    let lights = [new Light(new Vector(-30, 25, -12), Color.White)];
...
export function AssortedShapes50(reflection = 0.5) {    
    ...
    let shapes = [
        ...
        new Sphere(new Vector(10, 1, 12), 0.5, new Appearance(Color.Magenta, shiny)),
        new Sphere(new Vector(12, 2, -12), 0.5, new Appearance(Color.Yellow, shiny)),
        ...
        new Sphere(new Vector(8, 8, -8), 2, new Appearance(Color.Blue, shiny)),
        new Sphere(new Vector(-20.5, 4, -15), 0.5, new Appearance(Color.Cyan, shiny)),

        new Sphere(new Vector(-10.9, 1, -10), 0.5, new Appearance(Color.Grey, shiny)),
        new Sphere(new Vector(-18, 1, 6), 0.5, new Appearance(Color.Red, shiny)),
        new Sphere(new Vector(-14, 1, 3), 0.5, new Appearance(Color.Magenta, shiny)),
...
export function AssortedBoxes(reflection = 0.5) {    
    let shiny = new Finish({ shiny: 0.5, reflection: reflection });
    let camera = new Camera(new Vector(-10, 10, -10), new Vector(0, 4, 0));
    let background = new Color(0, 0, 0);
    let lights = [new Light(new Vector(-30, 25, -12), Color.White)];
    let shapes = [
        new Plane(Vector.Y, 0, new Appearance(Color.White)),
...
export function AssortedBoxes10(reflection = 0.5) {    
    let shiny = new Finish({ shiny: 0.5, reflection: reflection });
    let camera = new Camera(new Vector(-10, 12, -22), new Vector(0, 4, 0));
    let background = new Color(0, 0, 0);
    let lights = [new Light(new Vector(-30, 25, -12), Color.White)];
    let shapes = [
        new Plane(Vector.Y, 0, new Appearance(Color.White)),
...
export function AssortedBoxes50(reflection = 0.5) {    
    let shiny = new Finish({ shiny: 0.5, reflection: reflection });
    let camera = new Camera(new Vector(-10, 20, -30), new Vector(0, 4, 0));
    let background = new Color(0, 0, 0);
    let lights = [new Light(new Vector(-30, 25, -12), Color.White)];
    let shapes = [
        new Plane(Vector.Y, 0, new Appearance(Color.White)),
